...
<script>
	...
	function checkID(){		
		if(checkValue(mem.t_id,"id입력 후 중복검사 하시오")) return;
		
		$.ajax({
			type : "POST",     //어떤방식으로 넘길거냐
			url : "member_checkid.jsp",
			//url이 실행되면서 url의 소스(브라우저에 찍힌 소스)가 data라는 변수 안에 들어감.
			data: "t_id="+mem.t_id.value, //t_id = url에 넘어갈 변수(mem.t_id.value를 t_id라는 변수에 담아서 url에 넘긴다 )
                ...
                <tbody id="joinDataBody">
                    ...
                    <tr>
                        ...
                        <td>                           
                            ...
                            <input type="text" name="t_mobile_3" id="mphonNo3" class="w95" value="" maxlength="4"><label for="mphonNo3" class="blind">마직막번호</label>
                        </td>
                    </tr> 
                    <tr>
