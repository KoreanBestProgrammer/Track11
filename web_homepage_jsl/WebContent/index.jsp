	...
	<div class="top_navigation">
		...
		<header class="header">
			...
			<div class="gnb_group">
				...
				<nav class="gnb">
					<ul class="nav_1depth">
						<li><a href="gratings.jsl">기업소개</a>
							<ul class="nav_2depth">
								<li><a href="about/gratings.jsl">인사말</a></li>
								<li><a href="about/history.jsl">연혁 및 </a></li>
								<li><a href="about/gratings.jsl">교직원소개</a></li>
								<li><a href="gallery/photo.jsl">대우갤러리</a></li>
								<li><a href="about/map.jsl">찾아오시는길</a></li>
							</ul>
						</li>
						<!--<li><a href="allclass.jsl">학과및모집안내</a>
							<ul class="nav_2depth">
								<li><a href="#">전체모집과정</a></li>
								<li><a href="#">스마트웹콘텐츠개발과정</a></li>
							</ul>
						</li> -->
						<li><a href="portfolio.jsl">포트폴리오</a>
							<ul class="nav_2depth">
								<li><a href="portfolio/portfolio.jsl">포트폴리오</a></li>
							</ul>
						</li>
						<!-- <li><a href="online.jsl">온라인접수</a>
							<ul class="nav_2depth">
						...
						<li><a href="notice/notice_list.jsp">커뮤니티</a>
							<ul class="nav_2depth">
								...
								<%if(sessionLevel.equals("top")){ %>
									<li><a href="adm/admin_login.jsp">관리자</a></li>
								<%} %>
							</ul>
						</li>
					</ul>
