...
<script>
	function goUpdate(){
		if(checkValue(notice.t_title,"제목을 입력하시오")) return;
		if(checkValue(notice.t_content,"내용을 입력하시오")) return;
	...
	<div class="container">
	  ...
	  <!-- action을 처리하기전에 check()사용자 함수를 실행하고 되돌아 와라-->
			...
			<div class="btn_wrap">
				...
				<input type="button" value="목록" class="btn_list" onClick="location.href='notice.html';">
			</div>
		</form>
	  </div>
