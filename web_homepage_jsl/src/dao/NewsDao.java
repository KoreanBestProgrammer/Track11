...
public class NewsDao {
	...
	public int getNewsSave(NewsDto dto) {
		...
		String query = "insert into home_김용석_news\r\n" + 
					   ...
					   "values('"+dto.getNo()+"','"+dto.getTitle()+"','"+dto.getContent()+"','"+dto.getReg_id()+"', \r\n" + 
	...
	public ArrayList<NewsDto> getNewsList(String gubun,String search,int start,int end) {
		...
		String query = "select * from\r\n" + 
				...
				"        (select n.no,n.title,n.content,m.name,to_char(n.reg_date,'yyyy-mm-dd')as reg_date,n.hit \r\n" + 
	...
	public NewsDto getNewsView(String no) {
		...
		try {
			...
			if(rs.next()) {				
				...
				dto = new NewsDto(no,title,content,reg_date,update_date,name,hit);
			}
		}catch(Exception e) {
			System.out.println("쿼리오류"+query);
			e.printStackTrace();
