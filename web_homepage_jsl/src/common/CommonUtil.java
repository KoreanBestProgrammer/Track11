...
public class CommonUtil {
	...
	public static String getFile_dir_notice() {
		String noticeDir = "C:/track11_kys/work_project/web_homepage_jsl/WebContent/attach/notice/";
		return noticeDir;
	}
	public static String getFile_dir_news() {
		String newsDir = "C:/track11_kys/work_project/web_homepage_jsl/WebContent/attach/news/";
		return newsDir;
	}
