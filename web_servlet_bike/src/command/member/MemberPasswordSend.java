...
public class MemberPasswordSend implements CommonExecute {
	...
	public void execute(HttpServletRequest request) {
		...
		if(memberName == "") {
			...
			int pwLeng = sendPassword.length();
			...
			if(result != 1) {
				...
				String mailSet_ID="hjkl3031";        // 보내는 메일 ID
				String mailSet_PW="kimys303177";        // 보내는 메일 비밀번호
				
				String mailFromName ="JSL인재개발원"; // 보내는 사람 이름
				String mailFromAddress ="hjkl3031@naver.com"; // 보내는 메일 주소
