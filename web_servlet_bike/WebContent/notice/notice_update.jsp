			...
			<table class="boardForm">
				...
				<tbody>
					...
					<tr>
						<th>Attach</th>
						<td colspan="3">
						<c:if test="${not empty t_dto.getAttach()}"> <!-- el표현식에서는 'null이 아닐때'를 '공백이 아닐때'로 표현함 -->
							${t_dto.getAttach()} 삭제<input type="checkbox" name="t_deleteCheckbox" value="${t_dto.getAttach()}"><br> <!-- 체크박스 체크 안하면 value값 안넘어감 -->
